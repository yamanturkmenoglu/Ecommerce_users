...
class ItemsForYouListHome extends GetView<HomeControllerImp> {
  const ItemsForYouListHome({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: ListView.builder(
            itemCount: controller.itemsrand.length,
            scrollDirection: Axis.horizontal,
            itemBuilder: ((context, index) {
              return Itemshome(
                itemsmodel: Itemsmodel.fromJson(controller.itemsrand[index]),
              );
            })));
  }
}
